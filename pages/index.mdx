...
<div align="center">
  [Get Started](/docs/) · [Playground](/playground) · [GitHub
...
There are several ways to run FTA ([see the docs](/docs/)), but the easiest and fastest way is to use `fta-cli`:
...
Run `fta-cli` against a TypeScript project:
